...
/// </summary>
public class AnthropicStreamingTests : IDisposable
{
    ...
    public AnthropicStreamingTests()
    {
    ...
    public async Task SendMessageAsync_WithStreamingTextResponse_ReturnsMultipleUpdates()
    {
        ...
        {
            MessageTestHelper.CreateUserMessage("Explain quantum computing in simple terms")
        };

        var streamingResponses = new[] { "Quantum computing", " uses quantum mechanics", " to process information", " differently", " than classical computers." };
