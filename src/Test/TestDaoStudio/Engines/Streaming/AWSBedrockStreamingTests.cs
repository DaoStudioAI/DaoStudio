...
/// <summary>
/// Unit tests for AWS Bedrock streaming functionality.
/// Tests streaming message responses and multi-part content delivery.
/// </summary>
public class AWSBedrockStreamingTests : IDisposable
{
    ...
    public AWSBedrockStreamingTests()
    {
    ...
    public async Task SendMessageAsync_WithStreamingTextResponse_ReturnsMultipleUpdates()
    {
        ...
        {
            MessageTestHelper.CreateUserMessage("Explain cloud computing architecture")
        };

        var streamingResponses = new[] { "Cloud computing", " architecture involves", " multiple layers", " including infrastructure", " and services." };
