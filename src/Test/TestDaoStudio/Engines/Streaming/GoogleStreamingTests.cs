...
/// <summary>
/// Unit tests for Google streaming functionality.
/// Tests streaming message responses and multi-part content delivery.
/// </summary>
public class GoogleStreamingTests : IDisposable
{
    ...
    public async Task SendMessageAsync_WithStreamingTextResponse_ReturnsMultipleUpdates()
    {
        ...
        {
            MessageTestHelper.CreateUserMessage("Explain machine learning concepts")
        };

        var streamingResponses = new[] { "Machine learning", " is a subset", " of artificial intelligence", " that enables", " computers to learn." };
