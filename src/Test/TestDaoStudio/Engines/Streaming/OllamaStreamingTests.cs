...
/// </summary>
public class OllamaStreamingTests : IDisposable
{
    ...
    public async Task SendMessageAsync_WithStreamingTextResponse_ReturnsMultipleUpdates()
    {
        ...
        {
            MessageTestHelper.CreateUserMessage("Write a poem about local AI models")
        };

        var streamingResponses = new[] { "Local models run", " on your machine", " privately", " and securely", " without cloud dependency." };
