...
{
    /// <summary>
    /// Testable version of AnthropicEngine that allows injecting IChatClient for testing
    /// </summary>
    internal class TestableAnthropicEngine : AnthropicEngine
    {
        private readonly IChatClient? _injectedChatClient;

        public TestableAnthropicEngine(
            IPerson person, 
